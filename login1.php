...
html,body{
  ...
  width: 100%;
  place-items: center;
  background: -webkit-linear-gradient(left, #c3c3c3, #c3c3c3);
}
::selection{
  background: #fa4299;
  color: #fff;
...
.slide-controls .slider-tab{
  ...
  z-index: 0;
  border-radius: 5px;
  background: -webkit-linear-gradient(left, #e237ab, #c3c3c3);
  transition: all 0.6s cubic-bezier(0.68,-0.55,0.265,1.55);
}
input[type="radio"]{
  display: none;
...
form .btn .btn-layer{
  ...
  position: absolute;
  left: -100%;
  background: -webkit-linear-gradient(right, #e237ab, #9e4d84, #e237ab, #e237ab);
  border-radius: 5px;
